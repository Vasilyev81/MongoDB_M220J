...
public class MovieDao extends AbstractMFlixDao {
	...
	private boolean validIdValue(String movieId) {
		...
		//TODO> Ticket: Handling Errors - implement a way to catch a any potential exceptions thrown while validating a movie id.
		//Check out this method's use in the method that follows.
		//Error: Error Handling: The return from the api was incorrect when providing a bad id to search by
 ...
 /*private Bson buildLookupStage() {
      //TODO>Ticket Implement a $lookup stage to retrieve a comments
    ;
    return Aggregates.lookup("comments", "movie_id", "_id", "comments");
  }*/
