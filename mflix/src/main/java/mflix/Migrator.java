...
public class Migrator {
	 ...
	 * update $set to Date type. db.movies.update({_id: doc._id}, {$set: {lastupdated: ISODate(doc.lastupdated)}})
	 *
	...
	public static void main(String[] args) {
		...
		String mongoUri = "mongodb+srv://m220student:m220password@mflix-nv0hf.mongodb.net/test?retryWrites=true&maxPoolSize=50";
		...
		String datePattern = "yyyy-MM-dd HH:mm:ss"; // 2015-08-12 00:06:02.720000000
