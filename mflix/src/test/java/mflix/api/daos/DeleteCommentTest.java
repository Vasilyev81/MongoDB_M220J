...
public class DeleteCommentTest extends TicketTest {
  ...
  public void tearDown() {
    ...
    this.mongoClient.getDatabase("mflix").getCollection("comments").withWriteConcern(WriteConcern.MAJORITY).deleteMany(and(eq("email", "hello@valid.io"), eq("name", "some name")));
  }
}
